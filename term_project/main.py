...
def convert_annotation(image_id, list_file):
    in_file = open(
        '/data/NFS/andy_data/yolo/kaggle_facemask/annotations/%s.xml' % (image_id))
...
for image_set in sets:
    image_ids = open('/data/NFS/andy_data/yolo/kaggle_facemask/%s.txt' %
    ...
    for image_id in image_ids:
        list_file.write(
            '/data/NFS/andy_data/yolo/kaggle_facemask/images/%s.png' % (image_id))
...
yolo_model = YOLO(model_path=log_dir +
                  'trained_weights_final.h5', classes_path=classes_path)


image = Image.open(
    "/data/NFS/andy_data/yolo/kaggle_facemask/images/maksssksksss805.png")
