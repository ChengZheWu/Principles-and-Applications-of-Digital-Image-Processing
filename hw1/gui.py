...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(260, 160, 121, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.pushButton_3.setFont(font)
        self.pushButton_3.setObjectName("pushButton_3")
        self.radioButton = QtWidgets.QRadioButton(Form)
        self.radioButton.setGeometry(QtCore.QRect(40, 120, 83, 16))
        self.radioButton.setObjectName("radioButton")
        self.radioButton_2 = QtWidgets.QRadioButton(Form)
        self.radioButton_2.setGeometry(QtCore.QRect(40, 90, 83, 16))
    ...
    def retranslateUi(self, Form):
        ...
        self.radioButton.setText(_translate("Form", "2-1 Add 100"))
        self.radioButton_2.setText(_translate("Form", "origin"))
        self.radioButton_3.setText(_translate("Form", "2-2 Multiply 5"))
        self.radioButton_4.setText(_translate("Form", "2-3 Mean (2-1 and 2-2)"))
        self.radioButton_5.setText(_translate("Form", "2-4 G transform"))
